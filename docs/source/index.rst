...
**WaveformUncertainty** is a Python library that gives the infrastructure necessary for sampling over waveform uncertainty during parameter estimation runs. This infrastructure includes: waveform differences, the parameterization waveform differences for efficient storage and retrieval, a model for waveform uncertainty priors, a waveform model that includes waveform uncertainties, and a spline-based method for efficiently sampling over waveform uncertainty.  
